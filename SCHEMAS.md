...
> *Renders the schema families referenced in [`ecosystem-spec.json`](https://raw.githubusercontent.com/kody-w/rapp-god/main/api/v1/ecosystem-spec.json) v1.0.0 (`schemas_ref` + `primitives`) and the full ~80-schema table in [`ECOSYSTEM_MAP.md`](https://github.com/kody-w/RAPP/blob/main/ECOSYSTEM_MAP.md) §5.*
