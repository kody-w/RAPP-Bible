...
v1.1.1 `repos`. Each entry links to the Bible one-pager (which links upstream).
...
*Grouped per `ecosystem-spec.json` v1.1.1 `repos`. If a repo here disagrees with its upstream README, upstream wins.*
