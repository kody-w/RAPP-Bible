...
> *Renders the `capability_domains` of [`ecosystem-spec.json`](https://raw.githubusercontent.com/kody-w/rapp-god/main/api/v1/ecosystem-spec.json) v1.0.0 for a human reader.*
...
*Authority: `ecosystem-spec.json` v1.0.0 `capability_domains`. This page is the human rendering; the JSON is canonical.*
